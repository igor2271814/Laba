...
- <h2 id="uper">uper</h2>
  Для удобства навигации по сайту добавим функцию "якоря". Она нужна для быстрого перемеения из одной точки сайта в другую. Для этого в tile-1 был добавлен id
-     <div class="tile-1" id="anchor"></div>
...
1. Базовая страктура сайта создана с помощью div элементов (некоторые из них - grid по сути таблицы)
*     <div class="header">
