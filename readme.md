...
На текущий момент основная версия 0.5. Выполнены все задачи для лабораторной работы. Есть некоторые проблемы отображением tile_group, все остальное работает надежно как швейцарские часы. Мобильной версии сайта пока нет. Увидеть как это все выглядит можно <a href="https://igor2271814.github.io/Laba/">тут</a>
